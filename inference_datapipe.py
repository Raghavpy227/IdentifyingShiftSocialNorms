...
for InputExample objects. This code is specifically for 2005-2010 data frame . Change the dataframe 2011-2015. look at data_pipeline2.py to do so
'''
...
df=pd.read_csv(os.path.join(path,"RS_2005_10_inference_data.csv"))
...
while i < len(dataset):
    ...
    torch.save({"Data_loader":data_loader,"date":nd},os.path.join(path,"data_loader_2005_10_"+str(count)+".pt"))
    s3_client.upload_file(os.path.join(path,"data_loader_2005_10_"+str(count)+".pt"),'comment-extracted-reddit-files',"data_loader_2005_10_"+str(count)+".pt")
    print("uploaded dataloader")
    os.remove(os.path.join(path,"data_loader_2005_10_"+str(count)+".pt"))
    prev=i
    i=i+20000
    count=count+1  
